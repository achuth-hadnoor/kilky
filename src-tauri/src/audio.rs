...
lazy_static! {
    pub static ref DEFAULT_CONFIG: HashMap<&'static str, [u64; 2]> = {
...
pub fn get_default_config() -> &'static HashMap<&'static str, [u64; 2]> {
    &DEFAULT_CONFIG
}
