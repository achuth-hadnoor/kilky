  ...
  return (
    <StepContainer>
      ...
      <div className="flex-1 overflow-y-auto pr-2 -mr-2 space-y-6 mt-4 pb-10">
        {/* Testing Area */}
        <OnboardingCard className="p-0 overflow-hidden bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 relative h-32 group focus-within:ring-2 focus-within:ring-red-500/30 ">
          {/* Ghost Text Layer */}
          <div
          ...
          <textarea
            ...
            placeholder=""
            className="absolute inset-0 w-full h-full p-4 bg-transparent text-md font-medium leading-relaxed resize-none focus:outline-none text-red-600 dark:text-red-400 whitespace-pre-wrap break-all"
            spellCheck={false}
          />
        ...
        <OnboardingCard className="space-y-3">
          ...
          <div className="relative">
            <select
              ...
              className="w-full p-3 bg-black/5 dark:bg-white/5 rounded-xl border dark:border-white/10 border-black/10 text-sm focus:outline-none focus:ring-2 focus:ring-red-500/30 appearance-none cursor-pointer dark:text-white text-zinc-900"
            >
