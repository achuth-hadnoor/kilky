      ...
      <div className="space-y-4 ">
        ...
        <OnboardingCard className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] uppercase tracking-widest font-bold text-zinc-500">Permissions</span>
          </div>
        ...
        <OnboardingCard className="space-y-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] uppercase tracking-widest font-bold text-zinc-500">Audio Output</span>
          </div>
          <select
            value={selectedDevice}
            onChange={(e) => onDeviceChange(e.target.value)}
            className="w-full p-3 bg-white/5 rounded-xl border border-white/10 text-sm focus:outline-none focus:ring-2 focus:ring-white/20 appearance-none cursor-pointer text-white"
          >
            <option value="" className="bg-zinc-900">Default System Device</option>
            {audioDevices.map((device) => (
              <option key={device} value={device} className="bg-zinc-900">
                {device}
              </option>
            ))}
          </select>
